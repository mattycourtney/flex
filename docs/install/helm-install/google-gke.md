...
## Configure Gluu Flex
  You can use the Janssen [TUI](https://docs.jans.io/v1.5.0/janssen-server/kubernetes-ops/tui-k8s/) to configure Flex components. The TUI calls the Config API to perform ad hoc configuration. 
